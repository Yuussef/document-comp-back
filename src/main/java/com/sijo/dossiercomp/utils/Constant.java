...
public    final class Constant {
    ...
    public static String skills="Compétences principales :Azure Active Directory, System Center Configuration Manager, VMware ESX Servers, Vmware, Microsoft Azure, Linux, Windows PowerShell, Dynamic Host Configuration Protocol, Red Hat Enterprise Linux, Domain Name System (DNS).\\n\" +\n" +
